                ...
                if find_flag2 == 0:
                    if q[0].ci >= 5:
                        ...
                        if (q[0].ci == 0) or (cur - q[0].time) > 1:
                            ...
                            arp = Arp(operation=ArpOperation.Request, senderhwaddr=port.ethaddr,
                                      senderprotoaddr=port.ipaddr, targethwaddr='ff:ff:ff:ff:ff:ff',
                ...
                if arp is None:
                    ...
                    if arp.operation == 1:
                        ...
                        if index != -1:
                            ...
                            answer = create_ip_arp_reply(self.mac_list[index], arp.senderhwaddr, self.ip_list[index],
                                                         arp.senderprotoaddr)
